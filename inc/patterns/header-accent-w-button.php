 ...
 */
return array(
	'title'      => __( 'Header, accent color with button', 'robertdevore-2022' ),
	'categories' => array( 'robertdevore-2022', 'header' ),
	...
	'content'    => '
		...
		<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link" style="padding-top:0.5rem;padding-right:0.85rem;padding-bottom:0.5rem;padding-left:0.85rem">' . esc_html__( 'Follow', 'robertdevore-2022' ) . '</a></div>
		<!-- /wp:button --></div>
		<!-- /wp:buttons -->
