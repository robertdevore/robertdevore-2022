 ...
 */
return array(
	'title'    => __( '404 content', 'robertdevore-2022' ),
	'inserter' => false,
	...
	<div class="wp-block-cover alignfull is-light" style="min-height:100vh"><span aria-hidden="true"
			...
			alt="' . esc_html__( 'Two–masted Schooner with Dory (1894) by Winslow Homer', 'robertdevore-2022' ) . '"
			...
			<h3 class="has-text-align-center" id="whoops-that-page-is-gone">' . esc_html__( 'Whoops, that page is gone', 'robertdevore-2022' ) . '</h3>
			<!-- /wp:heading -->
		</div>
	</div>
	<!-- /wp:cover -->',
