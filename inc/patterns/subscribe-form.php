 ...
 */
return array(
	'title'      => __( 'Subscribe form', 'robertdevore-2022' ),
	...
	'content'    => '
		...
		<p class="has-text-align-center has-small-font-size"><strong>' . esc_html__( 'Sign up for free content', 'robertdevore-2022' ) . '</strong>' . esc_html__( 'Thousands of folks (3000+) regularly get my posts in their inbox. For free.', 'robertdevore-2022' ) . '</p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-align-center has-foreground-color has-text-color" style="font-size:0.75rem">' . esc_html__( 'By subscribing, you agree with my Terms & Privacy Policy.', 'robertdevore-2022' ) . '</p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:group --></div>
		<!-- /wp:group -->',
);
