 ...
 */
return array(
	'title'      => __( 'Header, accent color', 'robertdevore-2022' ),
	...
	'content'    => '
		...
		<!-- wp:search {"label":"","showLabel":false,"placeholder":"' . esc_html__( 'Search...', 'robertdevore-2022' ) . '","width":150,"widthUnit":"px","buttonText":"Search","buttonPosition":"no-button","style":{"border":{"width":"0rem","style":"none","radius":"12px"}},"className":"hide-on-mobile"} /--></div>
		<!-- /wp:group --></div>
		<!-- /wp:group -->
		</div>
		<!-- /wp:group -->',
